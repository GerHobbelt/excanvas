...
(function () {
  ...
  contextPrototype.drawImage = function (image, var_args) {
    ...
    vmlStr.push(' ">' ,
                ...
                ' width:', Math.round(dw), 'px;',
                ' height:', Math.round(dh), 'px;',
                ' overflow:hidden;">');
    
    // Draw a special cropping div if needed
    if (sx || sy) {
      vmlStr.push('<div style="width:', Math.ceil(dw + sx * dw / sw), 'px;',
                  ' height:', Math.ceil(dh + sy * dh / sh), 'px;',
                  ' filter:progid:DxImageTransform.Microsoft.Matrix(Dx=',
                  -sx * dw / sw, ',Dy=', -sy * dh / sh, ');">');
    }
    
    vmlStr.push('<div style="width:', Math.round(w * dw / sw), 'px;',
                ' height:', Math.round(h * dh / sh), 'px;',
